...
{
    /// <inheritdoc />
    public partial class TrainingCenterRestructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    DefaultAmount = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiptFooter = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    LogoPath = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    DefaultDueDay = table.Column<int>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassSchedules_StudentGroups_StudentGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Students_ResponsiblePersons_ResponsiblePersonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentFees_PaymentTypes_PaymentTypeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentFees_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Receipts_Users_IssuedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicLevels_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_StudentId_ClassScheduleId_AttendanceDate",
                table: "Attendances",
                columns: new[] { "StudentId", "ClassScheduleId", "AttendanceDate" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSchedules_StudentGroupId_DayOfWeek_StartTime",
                table: "ClassSchedules",
                columns: new[] { "StudentGroupId", "DayOfWeek", "StartTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Receipts_IssuedByUserId",
                table: "Receipts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResponsiblePersons_IsDeleted",
                table: "ResponsiblePersons",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ResponsiblePersons_LastName",
                table: "ResponsiblePersons",
                column: "LastName");

            migrationBuilder.CreateIndex(
                name: "IX_ResponsiblePersons_PhoneNumber",
                table: "ResponsiblePersons",
                column: "PhoneNumber");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentFees_CreatedByUserId",
                table: "StudentFees",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentFees_DueDate",
                table: "StudentFees",
                column: "DueDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentFees_Status",
                table: "StudentFees",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_StudentFees_StudentId_PaymentTypeId_Month_Year",
                table: "StudentFees",
                columns: new[] { "StudentId", "PaymentTypeId", "Month", "Year" });

            migrationBuilder.CreateIndex(
                name: "IX_StudentGroups_AcademicLevelId_Name",
                table: "StudentGroups",
                columns: new[] { "AcademicLevelId", "Name" },
                unique: true,
                filter: "\"IsDeleted\" = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_AcademicLevelId_StudentGroupId_Status",
                table: "Students",
                columns: new[] { "AcademicLevelId", "StudentGroupId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_ResponsiblePersonId",
                table: "Students",
